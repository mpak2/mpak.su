...
$tpl['location'] = strtr("/". implode("/", array_slice(explode("/", $_SERVER['REQUEST_URI']), 2)), array("/katalog/"=>"/catalog/"));

if(array_key_exists("null", $_GET) && $_POST['uri']){
	$from = strtr("/". implode("/", array_slice(explode("/", $_POST['uri']), 2)), array("/katalog/"=>"/catalog/"));
