...
if(!get($conf, "settings", "canonical") && !array_key_exists("null", $_GET) && ($conf['settings']['theme/*:admin'] != $conf['settings']['theme']) && !array_search($arg['fn'], ['ajax', 'json'])){ # Нет перезагрузки страницы адреса
