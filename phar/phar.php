...
}elseif(!$version = "v{$match[1]}.{$match[2]}.{$match[3]}"){ mpre("Сбор архива происходит всегда на версии одной ниже. Следующей версией добавляем архив к коммиту.");
}elseif(true){ print_r($match, $version);
