...
//			'bottom' => array('tr'=>'<tr>', 'td'=>"<td valign='top'>", 'shablon'=>'<tr><td>{config:url}</td></tr>'), # Формат записей таблицы
			...
			'title' => array('uid'=>'Пользователь', 'img'=>'Логотип', 'name'=>'Имя', 'sobst_id'=>'Собственность', 'prof_id'=>'Професс', 'sity'=>'Город'), # Название полей
//			'etitle'=> array(),
...
//			'hidden' => array('name', 'enabled'), # Скрытые поля
			'spisok' => array( # Список для отображения и редактирования
				...
				'sobst_id' => array('*'=>spisok("SELECT id, name FROM {$conf['db']['prefix']}{$arg['modpath']}_sobst")),
				'prof_id' => array('*'=>spisok("SELECT id, name FROM {$conf['db']['prefix']}{$arg['modpath']}_prof")),
				'tz_id' => array('*'=>spisok("SELECT id, name FROM {$conf['db']['prefix']}{$arg['modpath']}_tz")),
				'mop_id' => array('*'=>spisok("SELECT id, name FROM {$conf['db']['prefix']}{$arg['modpath']}_mop")),
				'src_id' => array('*'=>spisok("SELECT id, name FROM {$conf['db']['prefix']}{$arg['modpath']}_src")),
...
}elseif ($_GET['r'] == "{$conf['db']['prefix']}{$arg['modpath']}_sobst"){
	stable(
		array(
//			'dbconn' => $conf['db']['conn'],
			'url' => "/?m[{$arg['modpath']}]=admin&r={$_GET['r']}", # Ссылка для редактирования
...
//			'bottom' => array('tr'=>'<tr>', 'td'=>"<td valign='top'>", 'shablon'=>'<tr><td>{config:url}</td></tr>'), # Формат записей таблицы
			...
			'title' => array('name'=>'Имя', 'index'=>'Фирм', 'description'=>'Описание'), # Название полей
//			'etitle'=> array(),
...
}elseif ($_GET['r'] == "{$conf['db']['prefix']}{$arg['modpath']}_prof"){
	stable(
		array(
//			'dbconn' => $conf['db']['conn'],
			'url' => "/?m[{$arg['modpath']}]=admin&r={$_GET['r']}", # Ссылка для редактирования
...
}elseif ($_GET['r'] == "{$conf['db']['prefix']}{$arg['modpath']}_tz"){
	stable(
		array(
//			'dbconn' => $conf['db']['conn'],
			'url' => "/?m[{$arg['modpath']}]=admin&r={$_GET['r']}", # Ссылка для редактирования
...
}elseif ($_GET['r'] == "{$conf['db']['prefix']}{$arg['modpath']}_mop"){
	stable(
		array(
//			'dbconn' => $conf['db']['conn'],
			'url' => "/?m[{$arg['modpath']}]=admin&r={$_GET['r']}", # Ссылка для редактирования
...
}elseif ($_GET['r'] == "{$conf['db']['prefix']}{$arg['modpath']}_src"){
	stable(
		array(
//			'dbconn' => $conf['db']['conn'],
			'url' => "/?m[{$arg['modpath']}]=admin&r={$_GET['r']}", # Ссылка для редактирования
