<? if(empty($_POST)): ?>
	...
	<style>
		...
		<form id="reg" method='post'>
			<style>
				form#reg table td {padding:5px;}
			</style>
			<table width='100%' cellspacing='5' cellpadding='3' border='0'>
				<tr>
					<td align='right' width='30%'>Логин доступа</td>
					<td><input name='name' type='text' class='wt' placeholder="Имя под которым будут вас видеть другие участники" required></td>
				</tr>
				<tr>
					<td align='right'>E-mail</td>
					<td><input name='email' type='text' placeholder="Потребуется для восстановления доступа в случае утери аккаунта" class='wt'></td>
				</tr>
				<tr>
					<td align='right'>Пароль</td>
					<td><input name='pass' type='password' class='wt' placeholder="Выбирайте по возможности сложный пароль" required></td>
				</tr>
				<tr>
					<td align='right'>Повторите пароль</td>
					<td><input name='pass2' type='password' class='wt' placeholder="Повторное введение исключит ошибку при его вводе" required></td>
				</tr>
			...
			<!--			<iframe src="<?=$conf['settings']['users_reg_page']?>" style="width:100%;"></iframe>-->
				...
				<tr>
					<td>&nbsp;</td>
					<td><input name='add' type='submit' value='Зарегистрироваться'></td>
				</tr>
			</table>
		</form>
<? elseif($conf['tpl']['reg']): ?>
