...
?>
<script src="/include/jquery/mobilyslider/mobilyslider.js"></script>
...
<? for($i = 0; $i<3; $i++): ?>
	<div class="colls" style="max-height:164px; float:left; margin-left:8px;">
		<div class="sliderContent" style="width:280px; height:155px;">
			<? foreach($files as $v): shuffle($files); ?>
				<div class="item"><img src="/files/<?=$v['id']?>/w:275/h:150/c:1/null/img.png" alt="" /></div>
			<? endforeach; ?>
		</div>
	</div>
<? endfor; ?>
