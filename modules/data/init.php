...
mpqw("INSERT INTO `{$conf['db']['prefix']}settings` (`modpath`, `name`, `value`, `aid`, `description`) VALUES ('{$conf['db']['prefix']}', '{$conf['db']['prefix']}_type', 'Типы', '4', '')");
mpqw("INSERT INTO `{$conf['db']['prefix']}settings` (`modpath`, `name`, `value`, `aid`, `description`) VALUES ('{$conf['db']['prefix']}', '{$conf['db']['prefix']}_index=>title', 'cat_id,img,file,hide,name,type_id,w,h,c', '4', '')");
