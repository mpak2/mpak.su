 ...
 *
 *  Thanks to M. Alsup http://www.malsup.com for his SWF plugin that was the
basis for this code
 *
 ...
 *      after:   <div class=iframe>
 					<iframe id=content_iframe marginWidth=0 marginHeight=0
src="myIframe.html" frameBorder=0 width=640 height=480>
					</iframe>
				</div>
 *
 *  Usage:
 ...
 *  -----
 *
 *  Options are passed to the 'flash' function using a single Object.  The
options
 *  Object is a hash of key/value pairs.  The following option keys are
supported:
 *
 *  Options:
 *  -------
 ...
 *
 *  * height, width, version and background values can be embedded in the
classname using the following syntax:
 ...
 */
 ...
 jQuery.fn.iframe = function(options) {
    return this.each(function() {
        ...
        var $el = jQuery('<' + opts.elementType + ' class="' + opts.cls + '"></'
+ opts.elementType + '>');
