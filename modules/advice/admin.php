...
$conf['settings'] += array(
	"{$arg['modpath']}_index"=>"Рекомендации",
);
...
//			'bottom' => array('tr'=>'<tr>', 'td'=>"<td valign='top'>", 'shablon'=>'<tr><td>{config:url}</td></tr>'), # Формат записей таблицы
			...
			'title' => array('uid'=>'Пользователь', 'gid'=>'Группа', 'name'=>'Название', 'description'=>'Текст', 'link'=>'Ссылка', 'href'=>'Адрес'), # Название полей
//			'etitle'=> array(),
...
//			'hidden' => array('name', 'enabled'), # Скрытые поля
			'spisok' => array( # Список для отображения и редактирования
				...
				'gid' => array('*'=>array(0=>'Все')+spisok("SELECT id, name FROM {$conf['db']['prefix']}users_grp")),
