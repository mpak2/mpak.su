...
//			'bottom' => array('tr'=>'<tr>', 'td'=>"<td valign='top'>", 'shablon'=>'<tr><td>{config:url}</td></tr>'), # Формат записей таблицы
			...
			'type' => array('time'=>'timestamp', 'up'=>'timestamp', "name"=>($_GET['r'] == "{$conf['db']['prefix']}{$arg['modpath']}_files" ? 'file' : ""), 'period'=>"timecount", 'sort'=>'sort', 'img'=>'file', 'img2'=>'file', 'duration'=>'timecount', 'description'=>'textarea', 'text'=>'wysiwyg'), # Тип полей
			'ext' => array(
				'name'=>array('*'=>'*'),
