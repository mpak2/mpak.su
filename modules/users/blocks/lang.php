...
$lang = mpql(mpqw("SELECT * FROM {$conf['db']['prefix']}{$arg['modpath']}_lang"));

?>
<script>
	$(function(){
		$("#lang a").click(function(){
			lang_id = $(this).attr("lang_id");// alert(lang_id);
			$.post("/blocks/<?=$arg['blocknum']?>/null", {lang_id:lang_id}, function(data){
