...
if($argv){
	if(file_exists(__DIR__. "/../../../index.phar")){
		$conf["db"]["open_basedir"] = (ini_get("open_basedir") ?: dirname(dirname(dirname(dirname(__FILE__)))). "/beget.phar:". dirname(dirname(dirname(dirname(__FILE__)))));
		if($mpfunc = tmpopendir("include/mpfunc.php")){ include $mpfunc; }else{
			include "phar://../../../beget.phar/include/mpfunc.php";
