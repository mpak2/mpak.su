...
$fav = mpql(mpqw("SELECT * FROM {$conf['db']['prefix']}{$arg['modpath']}_index AS id LEFT JOIN {$conf['db']['prefix']}{$arg['modpath']}_url AS u ON id.url_id=u.id WHERE id.fav>0 AND id.uid=". (int)$arg['uid']));
