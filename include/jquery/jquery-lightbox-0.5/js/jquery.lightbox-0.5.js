...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/include/jquery/jquery-lightbox-0.5/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/include/jquery/jquery-lightbox-0.5/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/include/jquery/jquery-lightbox-0.5/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'/include/jquery/jquery-lightbox-0.5/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'/include/jquery/jquery-lightbox-0.5/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
					...
					<div id="lightbox-container-image">
						...
						<div id="lightbox-loading">
							<a href="#" id="lightbox-loading-link">
								<img src="/include/jquery-lightbox-0.5/images/lightbox-ico-loading.gif">
							</a>
						</div>
					</div>
				</div>
					...
					<div id="lightbox-container-image-data">
						...
						<div id="lightbox-secNav">
							<a href="#" id="lightbox-secNav-btnClose">
								<img src="/include/jquery-lightbox-0.5/images/lightbox-btn-close.gif">
							</a>
						</div>
					</div>
				</div>
