...
require_once mpopendir('include/facebook/Services_Facebook-0.2.14/Services/Facebook/Common.php');
require_once mpopendir('include/facebook/Services_Facebook-0.2.14/Services/Facebook/Exception.php');
...
class Services_Facebook
{
    ...
    {
        $file = mpopendir('include/facebook/Services_Facebook-0.2.14/Services/Facebook/' . $endPoint . '.php');
        include_once $file;
