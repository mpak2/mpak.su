...
stable(
	array(
		...
		'url' => "?m[admin_mess]=admin", # Ссылка для редактирования
		'name' => "{$GLOBALS['conf']['db']['prefix']}adminmess", # Имя таблицы базы данных
...
//		'bottom' => array('tr'=>'<tr>', 'td'=>"<td valign='top'>", 'shablon'=>'<tr><td>{config:url}</td></tr>'), # Формат записей таблицы
		...
		'title' => array('time'=>'Время', 'title'=>'Заголовок', 'mess'=>'Сообщение'), # Название полей
		'type' => array('mess'=>'textarea'), # Тип полей
...
//		'hidden' => array(), # Скрытые поля
		...
		'default' => array('time'=>date('Y.m.d H:i', time())), # Значение полей по умолчанию
