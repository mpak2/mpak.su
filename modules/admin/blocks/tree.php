			...
			<li index_id="<?=$catalog['id']?>">
				<div style="overflow:hidden;">
					<span style="float:right;">
						...
						<a href="/<?=$arg['modname']?>:<?=$arg['fn']?>/catalog_id:<?=$catalog['id']?>/0" title="Добавить категорию"><img src="img/add.png"></a>
						<a href="/<?=$arg['modname']?>:<?=$arg['fn']?>/catalog_id:<?=$catalog['id']?>/0" title="Добавить товар"><img src="img/round_add_green.png"></a>
						<a class="del" href="javascript:return false;" title="Удалить"><img src="img/delete.png"></a>
						<a href="/<?=$arg['modname']?>:<?=$arg['fn']?>/<?=$catalog['id']?>" title="Редактировать"><img src="img/edit.png"></a>
						<input type="checkbox">
					</span>
					<span>
